Feature: As a potential client i need to book a flight in the PHPTravel webpage
  ...
  Scenario: As a user I want to navigate PHPTravel and complete booking process
    ...
    And clicks the 1 result writing email mauriciooubina@hotmail.com password estoesunapruebA123
    And completes with name Mauricio Surname Oubina email mauriciooubina@hotmail.com phone 1234567890 birthday 1998-10-11 passport 12345 expiration 2022-12-22 nationality Argentina
    And pays with Visa number 4263982640269299 expiration 02/2023 cvv 837
